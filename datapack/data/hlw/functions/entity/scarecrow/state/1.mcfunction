...
execute if block ^ ^1.5 ^0.5 #hlw:unsolid_nofluids run teleport @s ^ ^ ^0.1
execute unless block ^ ^1.5 ^0.5 #hlw:unsolid_nofluids run scoreboard players set @s monkeyhue.entity.tempAI 1
execute if block ~ ~-1 ~ #hlw:unsolid_nofluids run teleport @s ^ ^-0.05 ^0.1
execute unless block ~ ~ ~ #hlw:unsolid_nofluids run teleport @s ^ ^0.1 ^0.1
