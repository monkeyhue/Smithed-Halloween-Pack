#-------------------------------------------------------------#
#
# Kaboomer state machine
#
#-------------------------------------------------------------#

execute on passengers on passengers unless entity @s[nbt={Health:1024f}] run function hlw:entity/hitbox/main
execute unless score @s monkeyhue.entity.AIState matches -1.. run function hlw:entity/kaboomer/init

#----- AI States -----#

# Idle
execute if score @s monkeyhue.entity.AIState matches 0 run function hlw:entity/kaboomer/state/0

# Wander
execute if score @s monkeyhue.entity.AIState matches 1 run function hlw:entity/kaboomer/state/1

# Chase
execute if score @s monkeyhue.entity.AIState matches 2 run function hlw:entity/kaboomer/state/2

# Attack
execute if score @s monkeyhue.entity.AIState matches 3 run function hlw:entity/kaboomer/state/3

#----- Other Behavior -----#
execute if score @s monkeyhue.entity.hurtTime matches 10 on passengers run function hlw:entity/kaboomer/anim/hurt
...
execute if score @s monkeyhue.entity.AIState matches -1 run function hlw:entity/kaboomer/state/die